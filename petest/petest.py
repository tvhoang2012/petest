...
raw_size = 0x1000 #int(align(0x1000, file_alignment))
virtual_size =0x1000 #int(align(0x1000, section_alignment))
raw_offset = 0x80000#int(align((pe.sections[last_section].PointerToRawData +
                   # pe.sections[last_section].SizeOfRawData),
                  # file_alignment))

virtual_offset = 0x84000# int(align((pe.sections[last_section].VirtualAddress +
